            		...
            		<div class="row">
	            		...
	            		<div class="col-lg-3 col-md-12 display-center">
		                    <div class="widget widget-about">
                            	<img src="<?php echo bloginfo('template_directory');?>/assets/images/photo-tour/logo.png" class="footer-logo" alt="PhotoTour Logo">
							...
							<div>
								<div class="widget">
									...
									<ul class="widget-list">
										...
										<li><a href="mailto:#"><i class="bi bi-envelope"></i> info@photo-tour.com</a></li>
									</ul>
								</div>
								<div class="widget">
