<?php
    ...
    function add_user_extra_information($user) {
        ...
        if(empty($profile_pic_url)) {
            ...
            $src = get_template_directory_uri().'/assets/images/photo-tour/cloud.png';
        } else {
        ...
        ?>
            <style>
                #login h1 a, .login h1 a {
                    background-image: url("<?php echo bloginfo('template_directory');?>/assets/images/photo-tour/logo.png");
                    width: 300px;
                    height: 140px;
                ...
                .login {
                    background-image: url("<?php echo bloginfo('template_directory');?>/assets/images/photo-tour/background-private.jpg");
