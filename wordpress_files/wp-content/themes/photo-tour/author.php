...
<main class="main">
    ...
    <!-- Page Header -->
	<div class="page-header text-center" style="background-image: url('<?php echo bloginfo('template_directory');?>/assets/images/photo-tour/authors-bg.jpg')">
		<div class="container">
    ...
    <div class="page-content">
                        ...
                        <img src="
                            <?php
                                ...
                                if(str_contains($user_profile_pic, "<") || empty($user_profile_pic)) {
                                    $user_profile_pic = bloginfo('template_directory').'/assets/images/photo-tour/user.jpg';
                                }
        ...
        <!-- Skills -->
        <div class="bg-image pt-7 pb-5 pt-md-12 pb-md-9" style="background-image: url(<?php echo bloginfo('template_directory');?>/assets/images/photo-tour/skills.jpg)">
            <div class="container">
                <div class="row">
